...
func checkDelegateArgs(denom string, args []interface{}) (*stakingtypes.MsgDelegate, error) {
	if len(args) != 3 {
...
func checkUndelegateArgs(denom string, args []interface{}) (*stakingtypes.MsgUndelegate, error) {
	if len(args) != 3 {
		return nil, fmt.Errorf("invalid input arguments. Expected 3, got %d", len(args))
	}
